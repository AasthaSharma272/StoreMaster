...
// Post function call to upload a new color
...
)
{
    try{
        ...
        // Creating a new color in the database with provided name and value and storeId
        ...
        // Returning the created color as JSON response
...
// Get function to get all the colors created in that particular store 
...
)
{
    try{
        ...
        //Getting all colors in the database with provided storeId
        ...
        // Returning the colors as JSON response
